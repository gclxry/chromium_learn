...
#ifndef CONTENT_SIMPLE_SIMPLE_CONTENT_RENDERER_CLIENT_H_
#define CONTENT_SIMPLE_SIMPLE_CONTENT_RENDERER_CLIENT_H_
...
class SimpleContentRendererClient : public ContentRendererClient {
 public:
  static SimpleContentRendererClient* Get();

  SimpleContentRendererClient();
  virtual ~SimpleContentRendererClient();
...
#endif  // CONTENT_SIMPLE_SIMPLE_CONTENT_RENDERER_CLIENT_H_
