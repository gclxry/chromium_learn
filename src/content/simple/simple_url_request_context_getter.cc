...
net::URLRequestContext* SimpleURLRequestContextGetter::GetURLRequestContext() {
  ...
  if (!url_request_context_) {
    ...
    network_delegate_.reset(new SimpleNetworkDelegate);
    if (command_line.HasSwitch(switches::kDumpRenderTree))
      SimpleNetworkDelegate::SetAcceptAllCookies(false);
...
scoped_refptr<base::SingleThreadTaskRunner>
    SimpleURLRequestContextGetter::GetNetworkTaskRunner() const {
