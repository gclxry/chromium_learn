...
namespace {
SimpleContentRendererClient* g_renderer_client;
}

SimpleContentRendererClient* SimpleContentRendererClient::Get() {
  return g_renderer_client;
}

SimpleContentRendererClient::SimpleContentRendererClient() {
  DCHECK(!g_renderer_client);
  //g_renderer_client = this;
  //if (CommandLine::ForCurrentProcess()->HasSwitch(switches::kDumpRenderTree)) {
  //  EnableWebTestProxyCreation(
  //      base::Bind(&SimpleContentRendererClient::WebTestProxyCreated,
...
//
//void SimpleContentRendererClient::LoadHyphenDictionary(
...
//}
//
//void SimpleContentRendererClient::RenderThreadStarted() {
...
//}
//
//void SimpleContentRendererClient::RenderViewCreated(RenderView* render_view) {
//  if (!CommandLine::ForCurrentProcess()->HasSwitch(switches::kDumpRenderTree))
//    return;
...
//}
//
//bool SimpleContentRendererClient::OverrideCreatePlugin(
...
//SimpleContentRendererClient::OverrideCreateWebMediaStreamCenter(
...
//SimpleContentRendererClient::OverrideCreateWebRTCPeerConnectionHandler(
...
//}
//
//WebClipboard* SimpleContentRendererClient::OverrideWebClipboard() {
//  if (!CommandLine::ForCurrentProcess()->HasSwitch(switches::kDumpRenderTree))
//    return NULL;
//  if (!clipboard_)
...
//}
//
//WebMimeRegistry* SimpleContentRendererClient::OverrideWebMimeRegistry() {
//  if (!CommandLine::ForCurrentProcess()->HasSwitch(switches::kDumpRenderTree))
//    return NULL;
//  if (!mime_registry_)
...
//}
//
//WebHyphenator* SimpleContentRendererClient::OverrideWebHyphenator() {
//  if (!CommandLine::ForCurrentProcess()->HasSwitch(switches::kDumpRenderTree))
//    return NULL;
//  if (!hyphenator_)
//    hyphenator_.reset(new webkit_glue::MockWebHyphenator);
...
//}
//
//WebThemeEngine* SimpleContentRendererClient::OverrideThemeEngine() {
//  if (!CommandLine::ForCurrentProcess()->HasSwitch(switches::kDumpRenderTree))
//    return NULL;
...
//}
//
//void SimpleContentRendererClient::WebTestProxyCreated(RenderView* render_view,
...
//}
//
//bool SimpleContentRendererClient::AllowBrowserPlugin(
